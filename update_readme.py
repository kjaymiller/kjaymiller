...
if __name__ == "__main__":
    ...
    latest_pcn_episode = get_episodes("https://feeds.transistor.fm/python-community-podcast")[0]
    template = environment.get_template('.readme_template.md')    
    latest_post = sorted(feedparser.parse('https://kjaymiller.com/blog.rss').entries, key= lambda x: x.published_parsed, reverse=True)[0]
